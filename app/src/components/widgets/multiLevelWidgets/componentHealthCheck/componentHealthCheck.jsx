...
import { PASSED, FAILED, SKIPPED, INTERRUPTED, UNTESTED, RUNNING } from 'common/constants/testStatuses';
import {
...
export class ComponentHealthCheck extends Component {
  ...
  getSpecificTestListLink = (value) => {
    ...
    const link = getStatisticsLink({
      statuses: [PASSED, FAILED, SKIPPED, INTERRUPTED, UNTESTED, RUNNING],
