...
export const mockData = {
  ...
  contentParameters: {
    contentFields: [
      ...
      'statistics$defects$test_bug$tb_1h7inqu51mgys',
      'statistics$defects$test_bug$tb_qecoiezu7sc8',
      'statistics$defects$test_bug$tb_1k1tyymqtlp46',
  ...
  content: {
    result: [
      {
        values: {
          statistics$defects$test_bug$tb001: '11',
      ...
      {
        values: {
          statistics$defects$test_bug$tb001: '2',
      ...
      {
        values: {
          statistics$defects$test_bug$tb001: '3',
          statistics$executions$skipped: '11',
          statistics$executions$total: '76',
      ...
      {
        values: {
          statistics$defects$test_bug$tb001: '4',
      ...
      {
        values: {
          statistics$defects$test_bug$tb001: '1',
      ...
      {
        values: {
          statistics$defects$test_bug$tb001: '0',
