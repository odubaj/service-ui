...
import { FAILED, SKIPPED, INTERRUPTED, UNTESTED, RUNNING } from 'common/constants/testStatuses';
import { getConfig } from './config/getConfig';
import styles from './nonPassedTestCasesTrendChart.scss';

const cx = classNames.bind(styles);

const FAILED_SKIPPED_UNTESTED_RUNNING_STATISTICS_KEY = 'statistics$executions$failedSkippedUntestedRunningTotal';
...
export class NonPassedTestCasesTrendChart extends Component {
  ...
  onChartClick = (data) => {
    ...
    const link = getStatisticsLink({
      statuses: [FAILED, SKIPPED, INTERRUPTED, UNTESTED, RUNNING],
    });
  ...
  legendConfig = {
    showLegend: true,
    legendProps: {
      items: [FAILED_SKIPPED_UNTESTED_RUNNING_STATISTICS_KEY],
      disabled: true,
    },
  };
