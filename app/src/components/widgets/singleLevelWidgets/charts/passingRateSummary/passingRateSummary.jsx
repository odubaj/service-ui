...
import { PASSED, FAILED, INTERRUPTED, SKIPPED, MANUAL } from 'common/constants/testStatuses';
...
export class PassingRateSummary extends Component {
  ...
  onChartClick = (data) => {
    ...
    const link = getStatisticsLink({
      statuses: data.id === STATS_PASSED ? [PASSED] : [FAILED, INTERRUPTED, SKIPPED, MANUAL],
