...
import { PASSED, FAILED, INTERRUPTED, SKIPPED, UNTESTED, RUNNING } from 'common/constants/testStatuses';
...
export class PassingRateSummary extends Component {
  ...
  onChartClick = (data) => {
    ...
    const link = getStatisticsLink({
      statuses: data.id === STATS_PASSED ? [PASSED] : [FAILED, INTERRUPTED, SKIPPED, UNTESTED, RUNNING],
