...
import { PASSED, FAILED, SKIPPED, IN_PROGRESS, UNTESTED, RUNNING } from 'common/constants/testStatuses';
...
export class StatusDropdown extends Component {
  ...
  generateOptions = (status) => {
    ...
    const STATUS_TYPES = status === IN_PROGRESS ? [] : [PASSED, FAILED, SKIPPED, UNTESTED, RUNNING];
