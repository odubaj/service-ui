  ...
  },
  {
    ...
    description: (
      <FormattedHTMLMessage
        ...
        defaultMessage={
          'Shows statistics of the last launch divided into 2 sections:</br> - Skipped, Passed, Failed, Untested </br> - Product Bug, System Issue, To Investigate, Automation Bugs, Untested Test.'
        }
      />
    ),
