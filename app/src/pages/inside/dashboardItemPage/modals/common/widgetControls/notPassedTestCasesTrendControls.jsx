...
import { STATS_TOTAL, STATS_FAILED, STATS_SKIPPED, STATS_MANUAL } from 'common/constants/statistics';
  ...
  constructor(props) {
    ...
    initializeControlsForm({
      contentParameters: widgetSettings.contentParameters || {
        contentFields: [STATS_FAILED, STATS_SKIPPED, STATS_TOTAL, STATS_MANUAL],
        widgetOptions: {},
